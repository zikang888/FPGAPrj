...
/* USER CODE BEGIN Header_oled_work */
/**
* @brief Function implementing the oled_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_oled_work */
__weak void oled_work(void const * argument)
{
  /* USER CODE BEGIN oled_work */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END oled_work */
}
...
__weak void key_work(void const * argument)
{
...
/* USER CODE BEGIN Header_uart_work */
/**
* @brief Function implementing the uart_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_uart_work */
__weak void uart_work(void const * argument)
{
  /* USER CODE BEGIN uart_work */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END uart_work */
}
