...
HD_PWD='D:/Vivado/Project/Multi_protocol/Multi_protocol.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_protocol_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_protocol_bd_wrapper.tcl -notrace
