...
HD_PWD='D:/Vivado/Project/Multi_protocol/Multi_protocol.runs/multi_protocol_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_protocol_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_protocol_bd_xbar_0.tcl
