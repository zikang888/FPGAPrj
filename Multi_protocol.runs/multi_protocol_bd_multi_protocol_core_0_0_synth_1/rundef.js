...
ISEStep( "vivado",
         "-log multi_protocol_bd_multi_protocol_core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_protocol_bd_multi_protocol_core_0_0.tcl" );
