...
set bd_src_dir [file join $build_dir ${proj_name}.srcs sources_1 bd $bd_name]
set bd_gen_dir [file join $build_dir ${proj_name}.gen sources_1 bd $bd_name]
...
set gp0_pc [create_bd_cell -type ip -vlnv xilinx.com:ip:axi_protocol_converter:2.1 axi_protocol_converter_0]
set_property -dict [list \
...
foreach pin [list \
    ...
    axi_protocol_converter_0/aresetn \
