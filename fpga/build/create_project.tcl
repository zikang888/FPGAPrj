...
create_project $proj_name $build_dir -part xc7z020clg484-2 -force
set_property target_language Verilog [current_project]
set_property simulator_language Mixed [current_project]

set rtl_dirs [list \
    [file join $source_dir fpga rtl common] \
    [file join $source_dir fpga rtl protocol] \
    [file join $source_dir fpga rtl top] \
]
...
foreach xdc [glob -nocomplain [file join $source_dir fpga constraints *.xdc]] {
    add_files -fileset constrs_1 -norecurse $xdc
}

foreach extension [list v sv] {
    foreach tb [glob -nocomplain [file join $source_dir fpga sim * *_tb.$extension]] {
...
puts "PROJECT_CREATED: [file join $build_dir ${proj_name}.xpr]"
close_project
if {![info exists ::MULTI_PROTOCOL_KEEP_VIVADO_OPEN] ||
    !$::MULTI_PROTOCOL_KEEP_VIVADO_OPEN} {
    exit
}
